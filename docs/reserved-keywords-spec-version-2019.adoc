...
_Note: In PartiQL a Quoted Identifier is case-sensitive; because of this rule, no result will get returned from the query shown in Example 3 with no Schema in the environment._
